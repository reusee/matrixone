...
func (m *Manager) Profiles() (
	...
	usages = append(usages, Usage{
		Header: `-cpu-profile file_path`,
		Desc:   `write cpu profile to the specified file`,
	})
	...
	usages = append(usages, Usage{
		Header: `-allocs-profile file_path`,
		Desc:   `write allocs profile to the specified file`,
	})
	...
	usages = append(usages, Usage{
		Header: `-heap-profile file_path`,
		Desc:   `write heap profile to the specified file`,
	})

	parsers = append(parsers, p.MatchStr("-heap-profile-threshold")(
		p.Uint64(&heapProfileThreshold)(nil)))
	usages = append(usages, Usage{
		Header: `-heap-profile-threshold bytes`,
		Desc:   `take a heap profile if mapped memory changes exceed the specified threshold bytes`,
	})
